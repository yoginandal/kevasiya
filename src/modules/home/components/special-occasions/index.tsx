  ...
  return (
    ...
    >
      <Link href={occasion.href} legacyBehavior>
        <a className="group rounded-2xl h-[220px] w-full max-w-[250px] shadow-md hover:shadow-xl transition-all duration-300 ease-in-out overflow-hidden transform hover:-translate-y-2 flex flex-col items-center justify-center p-6 text-center border border-gray-100 bg-white">
          <div
